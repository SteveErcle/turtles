...
function axisView_Callback(hObject, eventdata, handles)
...
% --- Executes on button press in movingAverage.
function movingAverage_Callback(hObject, eventdata, handles)
% hObject    handle to movingAverage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of movingAverage
...
% --- Executes on button press in hiLo.
function hiLo_Callback(hObject, eventdata, handles)
% hObject    handle to hiLo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of hiLo
...
% --- Executes on slider movement.
function axisSecondary_Callback(hObject, eventdata, handles)
% hObject    handle to axisSecondary (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function axisSecondary_CreateFcn(hObject, eventdata, handles)
% hObject    handle to axisSecondary (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in market.
function market_Callback(hObject, eventdata, handles)
% hObject    handle to market (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns market contents as cell array
%        contents{get(hObject,'Value')} returns selected item from market


% --- Executes during object creation, after setting all properties.
function market_CreateFcn(hObject, eventdata, handles)
% hObject    handle to market (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
